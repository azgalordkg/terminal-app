          ...
          <div className='flex items-center'>
            ...
            <span className='flex items-center'>
              ...
              <div className='relative'>
                <span
                  className={`${isFocused ? 'cursor-text' : 'cursor-text_disabled'}`}>{inputValue[cursorPosition]}</span>
                <span
                  className={`${isFocused ? 'cursor' : 'cursor_disabled'} ${inputValue[cursorPosition] ? 'cursor-absolute' : ''}`}
                />
              </div>
